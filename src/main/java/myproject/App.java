                            ...
                            .template(PodTemplateSpecArgs.builder()
                                    ...
                                    .spec(PodSpecArgs.builder()
                                            .containers(ContainerArgs.builder()
                                                    .name("nginx")
                                                    .image("nginx")
                                                    // lets set some stuff that shouldn't be set
                                                    // for pixee to find and fix
                                                    // omission of these values would also be bad
                                                    .securityContext(SecurityContextArgs.builder()
                                                        .runAsUser(0)
                                                        .allowPrivilegeEscalation(true)
                                                        .capabilities(CapabilitiesArgs.builder().add("ALL").build())
                                                        .build())
